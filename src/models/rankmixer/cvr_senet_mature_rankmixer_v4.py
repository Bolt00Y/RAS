# -*- coding: utf-8 -*-
"""Pure mature RankMixer v4 with a D=384 pSiLU-Stable token FFN.
...
Relative to v1, pSiLU-Stable removes the independent gate projection and the
elementwise gate/value product.  It keeps pre-LN, hidden/output RMSNorm, the
down-projection initialization, residual connection, mix_up and final LN.  The
surviving single up projection uses SiLU directly, making this a focused FFN
ablation instead of a wholesale RankMixer redesign.
...
class MLPModel(ModelBase):
    ...
    _COMPAT_BUILD = 'mature_rankmixer_v4_psilu_d384_tf_only_20260901'
    _EXPECTED_FIELD_COUNTS = (385, 835, 14)
    _GROUP_VERSION = 'pure_mature_rankmixer_base_3bucket_d384_psilu_l3_v4'
    _GROUP_CHECKSUMS = {
    ...
    def __init__(self, **_kwargs):
        ...
        # Configurable architecture. Defaults reproduce the v4 D384/L3 pSiLU run.
        ...
        logging.info(
            'Pure mature RankMixer v4: fields=%s, SENet=%s, T=%d, D=%d, '
            'FFN=pSiLU-Stable, L=%d, M=%d, creative=%d, head=%s, '
            'dense_params=%d',
