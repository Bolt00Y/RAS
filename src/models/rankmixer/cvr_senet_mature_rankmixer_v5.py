# -*- coding: utf-8 -*-
"""Pure mature RankMixer v5 with semantic local tokens and D=384 pSiLU.

The default configuration is the proposed D=384, L=3 controlled experiment:

* Base-only sparse inputs: common_user(385), item(835), creative(14), E=17.
* Proportionally scaled excitation2 SENet: user=384, item=192, creative=192.
* 10 common + 21 item semantic local tokens, plus one user/item global token.
* Every local token uses an independent Linear -> BN projection at D=384.
* Three mature mix_up + per-token pSiLU-Stable blocks, expansion=3.5 (M=1344).
* Mean pooling plus a proportionally scaled creative bypass of 48 dimensions.
* Proportionally scaled task tower [384, 192] with established Flood/Riemann BN.
* One fst_cvr sigmoid/BCE only.

Relative to the successfully exercised v4, only the local tokenizer changes.
The mature three-bucket input BN and SENet are retained, then common/item are
split back into field tensors and gathered into the frozen semantic groups from
cvr_bn_unimixer_v1. Creative is deliberately excluded from local tokenization;
it stays on the v4 SENet + bypass path. The v4 global token, RankMixer pSiLU,
pooling, CVR head, loss, data path and train/eval/export lifecycle are unchanged.
...
# Frozen 10 common + 21 item semantic groups copied from
# cvr_bn_unimixer_v1.py. Creative is intentionally not part of the local
# tokenizer in v5; it keeps the mature SENet + bypass path below.
_LOCAL_SEMANTIC_FEATURE_GROUPS = {
    'common': (
        ('common_user_profile_device_geo_lifecycle', _ids("""
        1001 1006 1014 1034 1035 1036 1041 1042 1043 1501
        1504 1505 1527 25003 866024 868023 10231 10232 10233 10522
        10601 1502 19013 19016 201704 20517 20521 21403 21404 25000
        25001 25002 25006 25044 25700 340121 790249 790250 790251
        """)),
        ('common_user_order_consumption_value', _ids("""
        10442 1104 1106 200306 201702 201914 201915 202218 2066 210000
        210001 21264 231056 231065 24082411 24082412 24082413 26017 26021 26025
        26107 863712 863729 866012 866014 866023 866027 866029 866054 866064
        866065 866070 870277 870324 795602 340123 340125 110153 110011
        """)),
        ('common_user_purchase_price_recency', _ids("""
        131480 16725 16727 16731 16733 16735 16737 16739 200300 200302
        200303 200304 200320 201756 201757 201939 21749 21750 862355 862376
        866034 866063 866069 33866903 870322 340093 110151 340122 200318 200319
        204530 204543 241125006 4418196 860031 860034 860037 860042 860045
        """)),
        ('common_longterm_view_exposure_interest', _ids("""
        10600 1063 1064 1065 1509 1512 1521 1524 18021 18094
        18098 18100 18105 18214 19024 200124 21055 21233 21238 21239
        21240 21246 21257 21258 21260 4500 4501 4502 4503 4504
        863014 866072 870311 2017702 4418192 031090 340063 340092 340054
        """)),
        ('common_longterm_click_fav_interest', _ids("""
        1121 12403 12438 200714 200715 200762 200764 201720 201905 201906
        201909 202144 2073 210015 210042 21355 21602 21610 231383 231384
        231484 25045 25046 2509 25702 25703 26035 33600031 863018 866041
        866066 866068 866071 866082 867603 340059 340086 340037 340001
        """)),
        ('common_query_text_intent', _ids("""
        12209 12402 15000 15002 16743 16744 25136 25138 27516 3006
        3007 3008 3009 6910 6911 6912 790220 790221 790222 790230
        794734 794768 794802 863044 863046 866013 2014601 2015703 160034 87560211
        340453 340394 340364 340374 340367 340451 340377 340455
        """)),
        ('common_query_retrieval_relevance', _ids("""
        200200 200214 200758 2104 211121 2112 600154 7007737 7007741 7007746
        7007755 794014 794015 794030 794031 794164 794178 794179 794200 794208
        794209 794210 794214 794215 863141 866250 866251 868413 868414 870025
        795014 795012 2015709 2015745 2022401 300091 306045 310614
        """)),
        ('common_realtime_session_action', _ids("""
        13037 13038 13039 200752 201930 201931 201932 201937 21010 21012
        21013 2123 2503 2504 25049 2505 2506 2507 300000 3014
        3015 3016 6900 860023 861818 862311 863030 866061 868404 868405
        868407 868427 870038 881402 881404 4439006 340109 340160
        """)),
        ('common_shortterm_candidate_funnel', _ids("""
        12235 18073 18078 18083 200413 201900 202223 202330 202333 202334
        21351 21359 21402 21663 865600 866103 867645 867648 870059 870069
        870130 881102 881104 881665 881687 881691 881711 882303 882304 882306
        882305 881820 881816 881842 881818 881834 881817 304322
        """)),
        ('common_shortterm_funnel_page_context', _ids("""
        21303 21307 21340 20518 2100 2101 2102 2103 215401 246003
        24904004 3001 1070 200305 202425 202426 21030 21031 21032 21033
        215311 215312 215343 215373 24082402 3003 3004 3020 3102 3103
        863024 866073 881203 881204 881206 881215 881663 881664
        """)),
    ),
    'item': (
        ('item_goods_category_brand_identity', _ids("""
        6007 10003 10013 10014 10016 10018 10020 10021 10022 10012
        10062 1086 13020 13021 13022 17194 200313 27631 302185 5001
        6001 6004 6008 6013 6021 6501 7001 7501 10068 10410
        24021 1600912 19041 19042 19044 19047 200727 200729 201705 24082417
        241215001 241215101
        """)),
        ('item_shop_static_quality_service', _ids("""
        600022 6206 10059 200311 200314 206056 500000 500300 500301 500302
        600024 820000 820004 27632 160070 302503 302552 302595 304911 304946
        304952 340076 5014 600100 600101 6012 6016 7002 7007708 7007710
        7007711 7007713 820001 820025 820061 881226 881237 881709 881721 881733
        881757 2015723
        """)),
        ('item_title_query_lexical_ner', _ids("""
        18504 6893 25116 6892 13009 13010 18501 18503 25113 25120
        340483 341358 4012 6871 6894 7809 13005 28013 28017 28019
        28023 2115 25106 28003 341105 341353 4007 4009 6870 7806
        13006 8112 87560214 10219 10419 24808118 4003 5410 6914 8501
        87560127 87560133
        """)),
        ('item_semantic_category_relevance', _ids("""
        211100 340100 341320 37615 37616 37617 37618 770584 3402761 13002
        211130 3400141 340044 6888 8502 204202 33204162 33204180 33204182 862616
        862844 864132 864157 864215 204242 33204187 864386 864410 340116 3401661
        341265 33866914 33868929 865682 882235 770656 770657 770607 864553 865093
        865344 865349
        """)),
        ('item_image_video_embedding_similarity', _ids("""
        200640 200780 201021 203742 212502 864743 864744 864770 864774 865118
        865275 865416 865421 33203301 33203302 33203303 33203308 33203320 33203330 33203332
        33203333 160077 2015493 206201 206301 206389 206563 206585 212402 212422
        212432 33203334 33205180 33205227 4418073 621856 6802 870001 882223 882225
        882227 882233
        """)),
        ('item_current_price_supply', _ids("""
        16759 27303 6046 863060 27308 22102 22119 302533 500150 500151
        131485 21762 27443 27445 27459 27606 770521 500103 16728 16742
        16746 20512 500158 6133 6134 6859 241215065 4017 500003 500015
        6041 12204 12205 12206 201716
        """)),
        ('item_coupon_promotion_discount', _ids("""
        22120 27635 276351 500121 500136 500137 868029 868030 10524 140707
        27447 27626 27634 27640 500120 500134 500135 868291 10528 24530
        27311 27316 27321 274471 622316 622555 6852 780011 2022429 2022444
        16726 27102 27616 500159 622530
        """)),
        ('item_user_purchase_price_preference', _ids("""
        131474 131475 131476 131478 131479 131482 203708 208000 208001 770461
        770462 770470 770471 10359 11006 131466 131467 131468 131470 131472
        131473 131483 131484 160065 206081 206082 21702 21743 21746 21752
        22106 33204181 900086 206510 22101
        """)),
        ('item_user_view_click_price_preference', _ids("""
        200181 21708 21728 22129 22131 24330 24332 27402 3401321 4418101
        770460 770469 867665 867685 870313 870315 206077 215393 21668 21669
        21726 21729 246004 246005 246006 246007 246014 33203310 33203311 33203312
        33203321 33203331 33866909 33866912 33866915
        """)),
        ('item_price_gap_rank_competitiveness', _ids("""
        340824 24541 206310 208011 208012 208013 208014 208015 21760 24328
        24496 24497 24498 27367 27507 33204185 33204186 33204196 33205186 33795608
        33795609 33795610 33868952 33868953 33868961 33868965 33868969 33868973 33868976 33868977
        794165 794201 794212 794213 900643
        """)),
        ('item_price_promotion_buypower_context', _ids("""
        201735 206550 302502 861219 870008 870012 870303 622533 10520 110041
        140700 500001 864219 870310 600001 881108 10216 10387 10388 25027
        5019 33866926 33868954 33868970 33868978 870177 208030 208034 208016 310601
        310602 310604 6011 60119 6047
        """)),
        ('item_goods_category_global_funnel', _ids("""
        10207 10213 10154 10160 10310 24108 24116 24121 24701 24703
        24705 24707 24708 24709 24711 24710 25506 600233 25504 10152
        24218 24246 621415 810107 810109 820003 19035 24702 24704 24706
        25501 25717 340028 341102 25515 33758666 10210 6131 600253 600255
        12122 212611
        """)),
        ('item_shop_brand_global_quality', _ids("""
        6224 6804 10407 10413 25008 25015 621414 622496 863069 160067
        24107 24115 25010 25011 25012 600102 241215011 241215038 24231 24237
        24242 24531 25014 304913 600112 6052 621412 621416 621872 621877
        621878 863056 6811 770568 810103 810132 7502 868036 302190 600200
        600201 600202
        """)),
        ('item_purchase_order_fav_affinity', _ids("""
        12157 25093 4014 770560 870279 131048 131049 21053 200106 21054
        21201 21202 26003 26007 302554 10010 1110 1111 12100 12118
        12119 12120 17033 200105 200310 200325 201809 201916 202096 206029
        2111 25073 25711 25721 25741 302302 304393 3400731 341103 341421
        870270 203797
        """)),
        ('item_longterm_exposure_view_affinity', _ids("""
        21051 200104 200765 21050 21052 304395 621842 861534 869300 870257
        304394 25059 7007715 7007716 870263 870264 231334 231344 231374 304451
        304452 770459 770468 863132 863210 1602601 1602631 200324 200615 200751
        200753 21034 21035 21036 21037 215334 215337 25048 3401371 870166
        863054 340756
        """)),
        ('item_click_stay_engagement', _ids("""
        206157 231333 3029611 28060 200107 200585 201717 201910 201911 20500
        20501 20504 20505 21242 231494 200315 200316 25751 25752 25754
        302342 302374 33203304 33203306 33203607 200317 33866919 33866925 4418001 7007714
        7704561 770473 770570 770571 860066 863133 33868943 33868950 340761 865341
        865342 865711
        """)),
        ('item_shortterm_candidate_funnel', _ids("""
        12111 12104 12110 12112 12117 12101 12113 12115 12155 10002
        10007 10008 12088 12092 12094 25060 770626 863009 863047 18010
        215350 215399 340070 770583 770627 770630 820027 820028 820029 820035
        863087 863286 868500 868513 17135 17136 17137 17139 868486 241215027
        241215127
        """)),
        ('item_session_page_position_context', _ids("""
        24082404 881284 341888 600249 600254 863062 881220 881221 881265 881267
        881309 881353 881681 881705 881717 21110 21114 21115 12134 12137
        12138 12140 160063 340096 881634 206051 340317 340321 340335 3403491
        770472 882326 882353 882354 882385 882416 882417 882419 882369 882371
        206206
        """)),
        ('item_i2i_graph_neighbor_recall', _ids("""
        17053 17062 17086 17107 794005 794021 794169 870402 17027 17177
        18197 200754 201825 201856 201912 201918 24082423 241125018 247030061 247031681
        302987 304383 3044501 304456 310588 340296 4061 620000 770588 770590
        770591 770592 860076 860090 881025 900017 900647 909043 865618 14237
        341104
        """)),
        ('item_u2i_q2i_query_recall', _ids("""
        861124 861201 861540 870357 27533 861213 870373 87560205 861504 863780
        863802 863808 863811 870340 17058 17071 17111 17178 27525 861060
        861612 862388 862391 870128 870195 870250 87580093 17088 18088 200406
        200756 200757 280501 280502 280602 280611 7704581 770467 909116 340827
        820007
        """)),
        ('item_recall_source_hit_rank_path', _ids("""
        340859 794202 794203 794204 794205 794206 794207 794211 867638 867689
        160033 200768 340856 770587 794007 794022 794023 794170 794171 864578
        864738 865420 870283 880448 881331 882401 131052 160043 160044 160049
        18004 18007 18035 200210 200269 200283 200284 310585 310586 87560220
        865726
        """)),
    ),
}

_LOCAL_SEMANTIC_GROUP_CHECKSUMS = {
    'common_user_profile_device_geo_lifecycle': '3459bb452f2f55bc42e1cf1c48d2f77963ada454a135ee2407f37c209630746e',
    'common_user_order_consumption_value': '8d25adfc34d7716e71a37e5549a103265df3142320c82416183fde1cdad3e800',
    'common_user_purchase_price_recency': '613f935b55d7224f8f918b2ddb90450576e16c7d291a9b71e85b4992e90c7bcc',
    'common_longterm_view_exposure_interest': '86f372096d144f39aa7e5aff3ebeab78e519c64d0432e057d3a72216fbfba6e1',
    'common_longterm_click_fav_interest': '23297dc2fb60167048eee750a43543ed2f1fb4503ca166d6930cf4dd09912ec9',
    'common_query_text_intent': '6568062554bab59c53f852dc05bbff5d86f178418794571f16ada43e905d9306',
    'common_query_retrieval_relevance': 'c7a0212bd02ba396a0ba5d164f3844e1f4db35ee5868bd91e983d99ca2229232',
    'common_realtime_session_action': '953a917f95e8f9ce349c464abafaae350e7c2e13d54421766efbbb43cc9eaa46',
    'common_shortterm_candidate_funnel': '4405add57300a263c7aa0d488477cef9f1dc64a8aa3840ab64b9ea48c070cc7e',
    'common_shortterm_funnel_page_context': '6a1e7bf65863e9cf1d06e79d6e2fc3be200569e0fa93ce1a64064f887790e4f7',
    'item_goods_category_brand_identity': 'a31490ca4bff7a79bafa1762048e2467a36dbbb563791a55418e733684a49125',
    'item_shop_static_quality_service': '6333dfc7a6318c58f6dc8726085f211153b69bd33740de9dc40567c8a00b396a',
    'item_title_query_lexical_ner': 'a12f986415411997662c9b6e68ba957e2a4a3f4cc86398508077793e11e912a0',
    'item_semantic_category_relevance': 'ed2d82cf5b6c65b025b352d602d0b1d48c25f1de2518632f725a59cbe46dfeab',
    'item_image_video_embedding_similarity': 'f36ef98720cbdffe3a8dc5bf6c3f1b978f7c7d85ac075c1f19a38dfd10555941',
    'item_current_price_supply': '9e9577eb3431ee64a774edd5b49fb46812c94a79d44e58ab29988797db2175d0',
    'item_coupon_promotion_discount': 'e5af6dc30ac9ec3d445d6964989552817b298cbbd7997542375787f6b7e68b03',
    'item_user_purchase_price_preference': '55ad76fe7ba0b5e9bcc72221600dda22da0d631a0e497ce31e9b0e403fdef1d4',
    'item_user_view_click_price_preference': '471686cf40ee0f46782aeaf9f1f5de1cd433a5cbb3fefbd207e4f4728f1b3be1',
    'item_price_gap_rank_competitiveness': 'b9087b5fdad000228339506b8b35838cefe7c8e59f498d4b3584a6b6158992bf',
    'item_price_promotion_buypower_context': 'ac31b86d0087b09ed9d81ab4cf0f1141a8b5a23b2050dabbfe2066a70a7dd7ca',
    'item_goods_category_global_funnel': '6fdd23458bc87d58bae23f9d4e69478c771887929d5553b65348305c485870d0',
    'item_shop_brand_global_quality': '0df8a161b1860527372ccfda2f8b9d4b3f39ea8ee302c57a47926b491877fd6d',
    'item_purchase_order_fav_affinity': 'e714e54b2788aa771aeb4b0c5f2d702af4fd666cc1b28ab6b8b6282860180262',
    'item_longterm_exposure_view_affinity': 'a2e5821175c146d6a8e5d83cfbdfe49f63c7ef80b8785facf34724ec74e6c433',
    'item_click_stay_engagement': 'e368da1b521547d61fa0276d5364fdb7b97b52517fc5ead896378ce96b0c2532',
    'item_shortterm_candidate_funnel': '76a87c2a9450f8f03a0112540511bee1429659f62fc427522e09cc7cc95f0286',
    'item_session_page_position_context': 'f31e856a2872c829b99fce6c696b45aff4710f6181218353b1e014b6d3c51820',
    'item_i2i_graph_neighbor_recall': '46bf0677aefca8b9e985d0d91640203c2058692f80ab7bb3040e39b9ee13c3b5',
    'item_u2i_q2i_query_recall': 'a4e16844cf9282526ea9c2e0818c980014462543c9d8fd8a94f7cb6b4ab931c3',
    'item_recall_source_hit_rank_path': '943c53eb51f41a16669b7d4ca917b23ae98b1f7c7842d8b19a4166033b01600b',
}
_LOCAL_SEMANTIC_BUCKET_CHECKSUMS = {
    'common': '17792b0cb762e571bcf6a160b7ed823b01ddd2179d3dab6f347983a4ceca1a45',
    'item': '85486332b496bbec04da584d72e9d09811010c4eb764fc0ac518aa389b3f1a0b',
}
...
class MLPModel(ModelBase):
    """Configurable Base-three-bucket semantic mature RankMixer model."""

    _COMPAT_BUILD = 'mature_rankmixer_v5_semantic_psilu_d384_tf_only_20260901'
    _EXPECTED_FIELD_COUNTS = (385, 835, 14)
    _EXPECTED_LOCAL_TOKEN_COUNTS = (10, 21)
    _GROUP_VERSION = 'pure_mature_rankmixer_semantic_common_item_d384_psilu_l3_v5'
    _GROUP_CHECKSUMS = {
    ...
    _LOCAL_SEMANTIC_FEATURE_GROUPS = _LOCAL_SEMANTIC_FEATURE_GROUPS
    _LOCAL_SEMANTIC_GROUP_CHECKSUMS = _LOCAL_SEMANTIC_GROUP_CHECKSUMS
    _LOCAL_SEMANTIC_BUCKET_CHECKSUMS = _LOCAL_SEMANTIC_BUCKET_CHECKSUMS
    ...
    def __init__(self, **_kwargs):
        ...
        # Configurable architecture. Defaults reproduce v4 D384/L3 pSiLU after
        # replacing only its local tokenizer with the frozen semantic version.
        ...
        self.user_senet_lowrank = int(_kwargs.get(
            'user_senet_lowrank', self.mixup_token_dim))
        self.item_senet_lowrank = int(_kwargs.get(
            'item_senet_lowrank', self.mixup_token_dim // 2))
        self.creative_senet_lowrank = int(_kwargs.get(
            'creative_senet_lowrank', self.mixup_token_dim // 2))
        self.global_token_hidden_dim = int(_kwargs.get('global_token_hidden_dim', 768))
        self.creative_output_dim = int(_kwargs.get('creative_output_dim', 48))
        self.creative_hidden_dim = int(_kwargs.get('creative_hidden_dim', 384))
        self.cvr_layers = [int(value) for value in _kwargs.get('cvr_layers', [384, 192])]
        ...
        logging.info(
            'Pure mature RankMixer v5: fields=%s, semantic_tokens=%s, '
            'SENet=%s, T=%d, D=%d, FFN=pSiLU-Stable, L=%d, M=%d, '
            'creative=%d, head=%s, '
            'dense_params=%d',
            self.feature_field_counts,
            self.semantic_token_order,
            (self.user_senet_lowrank,
             self.item_senet_lowrank,
             self.creative_senet_lowrank),
    ...
    def _validate_architecture_args(self, kwargs):
        positive_dimensions = {
            ...
            'user_senet_lowrank': self.user_senet_lowrank,
            'item_senet_lowrank': self.item_senet_lowrank,
            'creative_senet_lowrank': self.creative_senet_lowrank,
    ...
    def _validate_feature_contract(self):
        ...
        if self.feature_field_counts != self._EXPECTED_FIELD_COUNTS:
            logging.warning(
                'feature counts differ from the frozen mature baseline: '
                'baseline=%s, actual=%s',
        ...
        for group_name, feature_ids, _ in ordered_groups:
            ...
            if checksum != self._GROUP_CHECKSUMS[group_name]:
                logging.warning(
                    '%s routing differs from the frozen mature baseline checksum: %s',
                    group_name,
                    checksum,
                )
        ...
        if creative_checksum != self._GROUP_CHECKSUMS['creative']:
            logging.warning(
                'creative routing differs from the frozen mature baseline checksum: %s',
                creative_checksum,
            )
        ...
        if len(all_ids) != baseline_total:
            logging.warning(
                'routed field count differs from the frozen mature baseline: '
                'baseline=%d, actual=%d',
                baseline_total,
                len(all_ids),
            )
        ...
        if all_checksum != self._ALL_GROUPS_CHECKSUM:
            logging.warning(
                'complete routing differs from the frozen mature baseline checksum: %s',
                all_checksum,
            )

        semantic_bucket_names = ('common', 'item')
        if set(self._LOCAL_SEMANTIC_FEATURE_GROUPS.keys()) != set(
                semantic_bucket_names):
            raise ValueError(
                'v5 local semantic buckets must be common/item only, got {}'.format(
                    sorted(self._LOCAL_SEMANTIC_FEATURE_GROUPS.keys())))

        token_counts = tuple(
            len(self._LOCAL_SEMANTIC_FEATURE_GROUPS[bucket_name])
            for bucket_name in semantic_bucket_names
        )
        if token_counts != self._EXPECTED_LOCAL_TOKEN_COUNTS:
            raise ValueError(
                'semantic token counts={} must equal frozen {}'.format(
                    token_counts, self._EXPECTED_LOCAL_TOKEN_COUNTS))

        semantic_names = []
        semantic_all_ids = set()
        for bucket_name in semantic_bucket_names:
            bucket_ids = []
            for group_name, feature_ids in self._LOCAL_SEMANTIC_FEATURE_GROUPS[
                    bucket_name]:
                if group_name in semantic_names:
                    raise ValueError(
                        'duplicate semantic token group name: {}'.format(group_name))
                if not feature_ids:
                    raise ValueError(
                        'semantic token group {} is empty'.format(group_name))
                if len(feature_ids) != len(set(feature_ids)):
                    raise ValueError(
                        '{} contains duplicate semantic feature IDs'.format(group_name))
                overlap = semantic_all_ids.intersection(feature_ids)
                if overlap:
                    raise ValueError(
                        'semantic features assigned more than once: {}'.format(
                            sorted(overlap)))
                checksum = hashlib.sha256(
                    '\n'.join(feature_ids).encode('utf-8')).hexdigest()
                if checksum != self._LOCAL_SEMANTIC_GROUP_CHECKSUMS[group_name]:
                    raise ValueError(
                        '{} semantic routing checksum mismatch: {}'.format(
                            group_name, checksum))
                semantic_names.append(group_name)
                semantic_all_ids.update(feature_ids)
                bucket_ids.extend(feature_ids)

            bucket_set = set(bucket_ids)
            if bucket_set != group_sets[bucket_name]:
                raise ValueError(
                    'semantic mapping mismatch for {}: missing={}, unknown={}'.format(
                        bucket_name,
                        sorted(group_sets[bucket_name] - bucket_set),
                        sorted(bucket_set - group_sets[bucket_name]),
                    ))
            bucket_checksum = hashlib.sha256(
                '\n'.join(bucket_ids).encode('utf-8')).hexdigest()
            if bucket_checksum != self._LOCAL_SEMANTIC_BUCKET_CHECKSUMS[bucket_name]:
                raise ValueError(
                    '{} semantic token-order checksum mismatch: {}'.format(
                        bucket_name, bucket_checksum))

        creative_overlap = semantic_all_ids.intersection(_CREATIVE_IDS)
        if creative_overlap:
            raise ValueError(
                'creative must not enter v5 local semantic tokens: {}'.format(
                    sorted(creative_overlap)))

        self.semantic_token_order = tuple(semantic_names)
        self.local_token_num = sum(token_counts)
        if self.local_token_num + 1 != self.mixup_token_num:
            raise ValueError(
                'semantic groups produce {} local + 1 global tokens, but '
                'mixup_token_num={}'.format(
                    self.local_token_num, self.mixup_token_num))
    ...
    def _calculate_dense_trainable_params(self):
        ...
        if self.use_senet:
            senet_specs = (
                (user_width, self.user_senet_lowrank, user_width),
                (user_width + item_width,
                 self.item_senet_lowrank, item_width),
                (creative_width,
                 self.creative_senet_lowrank, creative_width),
            )
        ...
        # Each of the 31 semantic groups owns one [17*n_t, D] projection,
        # one D bias, and an always-on independent token BN (gamma/beta).
        local_tokens = 0
        for bucket_name in ('common', 'item'):
            for _, feature_ids in self._LOCAL_SEMANTIC_FEATURE_GROUPS[bucket_name]:
                input_width = len(feature_ids) * self.embedding_size
                local_tokens += input_width * token_dim
                local_tokens += token_dim
                local_tokens += 2 * token_dim
        ...
        # pSiLU-Stable has one per-token up projection instead of SwiGLU's
        # independent gate and value projections.  Norm terms are unchanged:
        # pre-LN (2D), hidden RMSNorm (M), output RMSNorm (D).
        per_mixer_layer = (
            token_num * token_dim * mixer_hidden + token_num * mixer_hidden
    ...
    def _per_token_psilu(self, inputs, layer_index, regularizer,
                         residual_scale=1.0):
        """Single-up pSiLU-Stable FFN using TensorFlow-1.x compatible ops.

        F(q) = RMSNorm_o(RMSNorm_h(SiLU(q W_u + b_u)) W_d + b_d).
        The legacy fc2/fc3 scope names intentionally identify the surviving
        v1 value/up and down projections; the v1 fc1 gate no longer exists.
        """
        ...
        up = self._matmul_dense(
            'pwff_fc2_{}'.format(layer_index),
            transposed,
            hidden_dimension,
            regularizer,
        )
        # SiLU(x) = x * sigmoid(x); this form works on the target TF 1.x stack.
    ...
    def _mlp_mixer_psilu(self, inputs, mode, regularizer):
        with tf.variable_scope(
    ...
    @staticmethod
    def _split_bucket_fields(bucket_tensor, ordered_feature_ids,
                             embedding_size, bucket_name):
        """Restore feature-id -> post-SENet tensor without changing field order."""
        expected_width = len(ordered_feature_ids) * embedding_size
        actual_width = bucket_tensor.get_shape().as_list()[-1]
        if actual_width != expected_width:
            raise ValueError(
                '{} post-SENet width={}, expected={}'.format(
                    bucket_name, actual_width, expected_width))
        field_tensors = tf.split(
            bucket_tensor,
            [embedding_size] * len(ordered_feature_ids),
            axis=1,
            name='{}_post_senet_fields'.format(bucket_name),
        )
        return dict(zip(ordered_feature_ids, field_tensors))

    def _project_semantic_group(self, field_tensors, bucket_name,
                                group_name, token_index, is_train,
                                export, regularizer):
        """Build one independent Linear -> BN semantic token."""
        token_input = (
            field_tensors[0]
            if len(field_tensors) == 1
            else tf.concat(field_tensors, axis=1, name='field_concat')
        )
        input_dim = token_input.get_shape().as_list()[-1]
        if input_dim is None:
            raise ValueError(
                '{} semantic token input width must be static'.format(group_name))
        expected_input_dim = len(field_tensors) * self.embedding_size
        if input_dim != expected_input_dim:
            raise ValueError(
                '{} semantic token width={}, expected={}'.format(
                    group_name, input_dim, expected_input_dim))
        ...
        with tf.variable_scope(
            ...
            # This BN is mandatory and token-specific, just like UniMixer v1.
            # The [B, D] input means statistics are collected along batch only;
            # the outer group scope provides independent gamma/beta/moving stats.
        ...
        logging.info(
            'RankMixer v5 token %02d %s/%s: fields=%d, input_dim=%d '
            '-> Linear/independent-BN D=%d',
            token_index,
            bucket_name,
            group_name,
            len(field_tensors),
    ...
    def _semantic_tokenize(self, bucket_field_maps, is_train, export,
        ...
        with tf.variable_scope(
                ...
                partitioner=self.partitioner):
            for bucket_name in ('common', 'item'):
                field_map = bucket_field_maps[bucket_name]
                for group_name, feature_ids in self._LOCAL_SEMANTIC_FEATURE_GROUPS[
                        bucket_name]:
                    missing = [feature_id for feature_id in feature_ids
                               if feature_id not in field_map]
                    if missing:
                        raise ValueError(
                            '{} missing post-SENet fields: {}'.format(
                                group_name, missing))
                    field_tensors = [field_map[feature_id]
                                     for feature_id in feature_ids]
                    tokens.append(self._project_semantic_group(
                        field_tensors,
                        bucket_name,
                        group_name,
                        token_index,
        ...
        if token_index != self.local_token_num:
            raise ValueError(
                'built {} semantic tokens, expected {}'.format(
                    token_index, self.local_token_num))
        stacked = tf.stack(tokens, axis=1, name='semantic_local_tokens')
        stacked.set_shape(
            [None, self.local_token_num, self.mixup_token_dim])
        tf.add_to_collection('mature_rankmixer_v5_semantic_tokens', stacked)
        return stacked
        ...
        with tf.variable_scope(
            ...
            if self.use_senet:
                user_senet = self._excitation2(
                    ...
                    lowrank=self.user_senet_lowrank,
                    scope='user', regularizer=regularizer)
                item_senet = self._excitation2(
                    tf.concat([user_bn, item_bn], axis=1),
                    item_bn,
                    is_train,
                    export,
                    lowrank=self.item_senet_lowrank,
                    scope='item',
                    regularizer=regularizer,
                )
                creative_senet = self._excitation2(
                    creative_bn, creative_bn, is_train, export,
                    lowrank=self.creative_senet_lowrank,
                    scope='creative', regularizer=regularizer)
            else:
                user_senet = user_bn
                item_senet = item_bn
                creative_senet = creative_bn

            # The mature bucket order and the semantic order are different.
            # Restore a field map after SENet first, then gather by semantic ID;
            # splitting the flat SENet output directly by semantic widths would
            # silently route fields into the wrong tokens.
            user_feature_ids = tuple(
                feature_id
            ...
            bucket_field_maps = {
                'common': self._split_bucket_fields(
                    user_senet,
                    user_feature_ids,
                    self.embedding_size,
                    'common',
                ),
                'item': self._split_bucket_fields(
                    item_senet,
                    item_feature_ids,
                    self.embedding_size,
                    'item',
            ...
            local_tokens = self._semantic_tokenize(
                bucket_field_maps,
                is_train,
                export,
                regularizer,
            )
            flattened_local_tokens = tf.reshape(
                local_tokens,
                [-1, self.local_token_num * self.mixup_token_dim],
                name='flattened_31_semantic_local_tokens',
            )
            ...
            flattened_tokens = tf.concat(
                [flattened_local_tokens, global_token],
                axis=1,
            ...
            mixed_tokens = self._mlp_mixer_psilu(
                tokens,
                mode=mode,
                regularizer=regularizer,
            )
