# -*- coding: utf-8 -*-
# rankmixer_v5版本：固定均衡字段分组 + Global Token + Mixing/Reverting + PreNorm Per-token SwiGLU
import os
import math
import hashlib
...
class MLPModel(ModelBase):
    ...
    def __init__(self, **_kwargs):
        ...
        # RankMixer v5: 31 local tokens + 1 global token, H=T=32, D=1024, L=2.
        ...
        self.rm_hidden_dim = int(_kwargs.get('rm_hidden_dim', 1024))
